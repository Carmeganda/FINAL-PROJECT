...
master['background'] = '#f3a6f7'

current_volume = float(1)
...
#Buttons
Button(master, text="Select Song", font=("Calibri", 12), command=play_song, bg="#f016a0").grid(row=2, sticky="N")
Button(master, text="Pause", font=("Calibri", 12), command= pause, bg="#9bf57d").grid(row=3, sticky="E")
Button(master, text="Resume", font=("Calibri", 12), command=resume, bg="#9bf57d").grid(row=3, sticky="W")
Button(master, text="-", font=("Calibri", 12), width=5, command=reduce_volume, bg="cyan").grid(row=5, sticky="W")
Button(master, text="+", font=("Calibri", 12), width=5, command=increase_volume, bg="cyan").grid(row=5, sticky="E")
